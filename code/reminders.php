	...
	while ( $row = $reminders->fetch_assoc() ) {
		...
		if ($row["deadline"] != $curr) {
			...
			if ($row["deadline"] === null) {
				$str = "Undated";
				echo "<div class='card'><div class='card-header' id='head" . $count . "'><h2 class='mb-0'><button class='btn btn-link btn-block text-left shadow-none d-flex flex-row' type='button' data-toggle='collapse' data-target='#collapse" . $count . "' aria-expanded='true' aria-controls='collapse" . $count . "'><div class='flex-grow-1 date'>Undated</div><div class='d-flex flex-column justify-content-center'><i class='far fa-caret-square-up'></i></div></button></h2></div><div id='collapse" . $count . "' class='collapse multi-collapse show' aria-labelledby='head" . $count . "'><div class='card-body'><ul class='list-group text-wrap reminders'><li class='list-group-item list-group-item-action d-flex flex-row justify-content-start' data-id='" . $row["id"] . "' data-notes='" . $row["notes"] . "'><div class='d-flex flex-column justify-content-center button check'><i class='" . $icon . "'></i></div><div class='item" . $crossed . "'><span>" . htmlspecialchars($row["title"]) . "</span></div><div class='flex-grow-1'></div><div class='d-flex flex-column justify-content-center button edit'><i class='fas fa-edit'></i></div><div class='d-flex flex-column justify-content-center button trash'><i class='far fa-trash-alt'></i></div></li>";
			...
			echo "<li class='list-group-item list-group-item-action d-flex flex-row justify-content-start' data-id='" . $row["id"] . "' data-notes='" . $row["notes"] . "'><div class='d-flex flex-column justify-content-center button check'><i class='" . $icon . "'></i></div><div class='item" . $crossed . "'><span>" . htmlspecialchars($row["title"]) . "</span></div><div class='flex-grow-1'></div><div class='d-flex flex-column justify-content-center button edit'><i class='fas fa-edit'></i></div><div class='d-flex flex-column justify-content-center button trash'><i class='far fa-trash-alt'></i></div></li>";
		}
